...
?>
<?php echo lang('security_scan_instructions'); ?>

<?php //<div id="progressbar"></div> ?>
...
<div>
	...
	{
		$value = ($value == 1 ? array('data' => 'Pass', 'class' => 'securitee_scan_pass_notice') : array('data' => 'Warning', 'class' => 'securitee_scan_warning_notice'));
